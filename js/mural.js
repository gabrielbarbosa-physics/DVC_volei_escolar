...
async function renderMural() {
    ...
    const projetoLogo = window.PROJETO_ATUAL_DVC?.logo || "Loki2.png";
    const projetoLogoFundoClaro = window.PROJETO_ATUAL_DVC?.logoFundoClaro || "Loki1.png";
    ...
    try {
        ...
        document.getElementById('mural-proximo-jogo').innerHTML = `
            <p class="text-[10px] font-black text-[#990000] uppercase mb-2">
                <i class="fa-solid fa-volleyball mr-1"></i> Próximo amistoso
            </p>
            ${jogoHtml}
        ...
        document.getElementById('mural-aniversariantes').innerHTML = `
            <p class="text-[10px] font-black text-[#990000] uppercase mb-2">
                <i class="fa-solid fa-cake-candles mr-1"></i> Aniversariantes do mês
            </p>
            ${aniversariantesHtml}
